...
print (totalCosts)
print("Total projected earnings for this portfolio: $" + str(totalProjectedEarnings))
print("Average projected change for this portfolio: " + str(totalProjectedChange) +"%")
